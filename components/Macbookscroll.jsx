...
export const MacbookScroll = ({
  ...
  return (
    <div
      ...
      {/* Base area */}
      <div
        className="relative -z-10 h-[22rem] w-[36rem] overflow-hidden rounded-2xl bg-gray-200 dark:bg-[#272729]">
        {/* above keyboard bar */}
...
export const Keypad = () => {
  return (
    <div
      className="mx-1 h-full [transform:translateZ(0)] rounded-md bg-[#050505] py-2 [will-change:transform]">
      {/* First Row */}
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px] ml-6">
        <KBtn
